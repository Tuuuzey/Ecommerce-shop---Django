...
TEMPLATES = [
    {
        ...
        'DIRS': [r'S:\django\Ecommerce\mysite\mysite\templates',
                 r'S:\django\Ecommerce\mysite\cart\templates',
                 r'S:\django\Ecommerce\mysite\user\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587 
EMAIL_USE_TLS = True 
EMAIL_HOST_USER = 'EcommerceShopDontReply@gmail.com' 
